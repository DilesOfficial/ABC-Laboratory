...
<head>
      ...
      <meta property="og:url" content="https://lhd.lk/our-tests" />
      <meta property="og:type" content="article" />
      <meta property="og:description" content="Our Tests" />
      <meta property="og:image" content="https://lhd.lk/images/banners/find-a-test-banner.jpg" />
...
.dropdown-item.activem {
 ...
 <!-- ***** Header Area Start ***** -->
    ...
    <form action="https://lhd.lk/LHDWEB1V1/index.php" method="post" class="form-inline" role="search">
        ...
        <section class="hero-area">
         <div class="img-fluid inner_banner" style="background-image: url(images/banners/find-a-test-banner.jpg); "></div>
  </section>
 ...
 <Style>
    ...
    .letter,.letter:hover,.letter:active{
    font-size:18px;
    width:16.6666667%;
    padding-top:10px;
    padding-bottom:10px;
    ...
    .one_test{
    padding: 10px;
    /* border :2px solid #1f9ff5; */
    /*background: #1f9ff5;*/
    /*color:white*/
    }

    .alphabet li.al-letter.active a{
        background-color: #91c644;
        color: #ffffff;
    }
</style>
<div class="col-12 medic_service_wrapper">
   <div class="medica-about-content medic_service medic_service_show path_01">
      <div>
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               <a href="our-tests0130.html?value=common" class="n_button blue">
               Common Tests
               </a>
            </div>
            <div class="col-md-4">
               <a href="our-tests54bc.html?value=all" class="n_button">
               All Tests
               </a>
            </div>
            <div class="col-md-2"></div>
      ...
      <div class="row">
         <div class="col-md-3 text-center">
            <h5>Browse by Test Name</h5>
            <ul class="alphabet">
                <li class="al-letter">
                  <a letter="A" class="letter" href="#">A</a>
               </li>
                <li class="al-letter">
                  <a letter="B" class="letter" href="#">B</a>
               </li>
                <li class="al-letter">
                  <a letter="C" class="letter" href="#">C</a>
               </li>
                <li class="al-letter">
                  <a letter="D" class="letter" href="#">D</a>
               </li>
                <li class="al-letter">
                  <a letter="E" class="letter" href="#">E</a>
               </li>
                <li class="al-letter">
                  <a letter="F" class="letter" href="#">F</a>
               </li>
                <li class="al-letter">
                  <a letter="G" class="letter" href="#">G</a>
               </li>
                <li class="al-letter">
                  <a letter="H" class="letter" href="#">H</a>
               </li>
                <li class="al-letter">
                  <a letter="I" class="letter" href="#">I</a>
               </li>
                <li class="al-letter">
                  <a letter="J" class="letter" href="#">J</a>
               </li>
                <li class="al-letter">
                  <a letter="K" class="letter" href="#">K</a>
               </li>
                <li class="al-letter">
                  <a letter="L" class="letter" href="#">L</a>
               </li>
                <li class="al-letter">
                  <a letter="M" class="letter" href="#">M</a>
               </li>
                <li class="al-letter">
                  <a letter="N" class="letter" href="#">N</a>
               </li>
                <li class="al-letter">
                  <a letter="O" class="letter" href="#">O</a>
               </li>
                <li class="al-letter">
                  <a letter="P" class="letter" href="#">P</a>
               </li>
                <li class="al-letter">
                  <a letter="Q" class="letter" href="#">Q</a>
               </li>
                <li class="al-letter">
                  <a letter="R" class="letter" href="#">R</a>
               </li>
                <li class="al-letter">
                  <a letter="S" class="letter" href="#">S</a>
               </li>
                <li class="al-letter">
                  <a letter="T" class="letter" href="#">T</a>
               </li>
                <li class="al-letter">
                  <a letter="U" class="letter" href="#">U</a>
               </li>
                <li class="al-letter">
                  <a letter="V" class="letter" href="#">V</a>
               </li>
                <li class="al-letter">
                  <a letter="W" class="letter" href="#">W</a>
               </li>
                <li class="al-letter">
                  <a letter="X" class="letter" href="#">X</a>
               </li>
                <li class="al-letter">
                  <a letter="Y" class="letter" href="#">Y</a>
               </li>
                <li class="al-letter">
                  <a letter="Z" class="letter" href="#">Z</a>
               </li>
            </ul>
         </div>
         <div class="col-md-9">
          <div class="text-center">
            ...
            <div id="searchResults" class="row t">
                           <div class="col-md-12">
                    <div class="one_test">                
                        <span class="test_tag_name">Test Name: </span> Urine Full Report (UFR)                            
                        <br>
                        <span class="test_tag_name">Test Code:&nbsp; </span> <span class="caps"> urine-full-report-ufr </span>
                    </div>
                </div>
                           <div class="col-md-12">
                    <div class="one_test">
                        <span class="test_tag_name">Test Name: </span> Thyroid Profile (TSH / fT4)                            
                        <br>
                        <span class="test_tag_name">Test Code:&nbsp; </span> <span class="caps"> thyroid-profile-tsh-ft4 </span>
                    </div>
                </div>
                           <div class="col-md-12">
                    <div class="one_test">
                        <span class="test_tag_name">Test Name: </span> 17-Hydroxyprogesterone(17-OH Progesterone)                           
                        <br>
                        <span class="test_tag_name">Test Code:&nbsp; </span> <span class="caps"> 3190 </span>
                    </div>
                </div>
                           <div class="col-md-12">
                    <div class="one_test">               
                        <span class="test_tag_name">Test Name: </span> 1 Cortisol [ACTH Stimulation Test/Short Synacthen test]                            
                        <br>
                        <span class="test_tag_name">Test Code:&nbsp; </span> <span class="caps"> 3103 </span>
                    </div>
                </div>
                           <div class="col-md-12">
                    <div class="one_test">                  
                        <span class="test_tag_name">Test Name: </span> Vitamin D (25-Hydroxy)                           
                         <br>
                        <span class="test_tag_name">Test Code:&nbsp; </span> <span class="caps"> 8823 </span>
                    </div>
                </div>
            </div>
        <div class="row">
            <div class="col-md-12">
                        <div style="cursor:pointer" id="seemore">
...
$(document).ready(function() {
    ...
    $(".al-letter").click(function(){
        $('.al-letter').removeClass("active")
    ...
    $("#seemore").click(function() {
        $.ajax({
            ...
            success: function(result) {
                ...
                var string = "";
                total_rows = result.count[0].fr
                noOfRows = Number(noOfRows) + Number(result.items.length);

                showHideSeemore();
                for (var x = 0; x < result.items.length; x++) {
                    string += '<div class="col-md-12">';
                    string += '<div class="one_test">';
                    string += '<span class="test_tag_name"> Test Name: </span>' + result.items[x].title;
                    string += '<br>';
                    string += '<span class="test_tag_name"> Test Code:&nbsp; </span><span class="caps">  ' + result.items[x].alias+'</span> ';
                    string += ' </div></div>';
                }
    ...
    $(".letter").click(function() {
        $(".letter").removeClass("activet");
        searchword = $(this).attr("letter");
        searchWord();
        $(this).removeClass("activet");
    })
    $("#searchTest").keyup(function() {
        searchword = $("#searchTest").val()
        searchWord()
    });
});
function searchWord() {
    $.ajax({
        ...
        success: function(result) {
            ...
            for (var x = 0; x < result.items.length; x++) {
                ...
                string += '<span class="test_tag_name"> Test Name: </span>' + result.items[x].title;
                string += '<br>';
                string += '<span class="test_tag_name"> Test Code:&nbsp; </span><span class="caps">' + result.items[x].xreference+'</span>';
                string += ' </div></div>';
            }
...
function showHideSeemore() {
    if (total_rows <= noOfRows) {
        $("#seemore").hide();
    } else {
        $("#seemore").show();
    }
