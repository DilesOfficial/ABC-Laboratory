...
<head>
    ...
    <link rel="stylesheet" href="templates/assets/style_ab43.css?test=1">
...
.dropdown-item.activem {
 ...
 <!-- ***** Header Area Start ***** -->
    ...
    <form action="https://lhd.lk/LHDWEB1V1/index.php" method="post" class="form-inline" role="search">
        ...
        <div class="hero-slides owl-carousel">
            <!-- Single Hero Slide -->
                         ...
                         <div class="single-hero-slide bg-img " style="background-image: url(images/banners/31-lh-pcr-test-new-banner.jpg);">
                <div class="container-fluid h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 h-100">
                            <div class="hero-slides-content hero_1">
                         ...
                         <div class="single-hero-slide bg-img " style="background-image: url(images/banners/home-banner-7.jpg);">
                <div class="container-fluid h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 h-100">
                            <div class="hero-slides-content hero_1">
                                <h2 data-animation="fadeInUp" data-delay="100ms">We apply the latest advances in research and technology</h2>                               
                            </div>
                        </div>
                    </div>
                </div>
            </div>
                         <div class="single-hero-slide bg-img " style="background-image: url(images/banners/home-banner-4.jpg);">
                <div class="container-fluid h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 h-100">
                            <div class="hero-slides-content hero_1">
                                <h2 data-animation="fadeInUp" data-delay="100ms">We are Sri Lanka's highest accredited laboratory</h2>                               
                            </div>
                        </div>
                    </div>
                </div>
            </div>
                         <div class="single-hero-slide bg-img " style="background-image: url(images/banners/home-banner-1.jpg);">
                <div class="container-fluid h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 h-100">
                            <div class="hero-slides-content hero_1">
                                <h2 data-animation="fadeInUp" data-delay="100ms">We are at the forefront of diagnostic care</h2>                               
                            </div>
                        </div>
                    </div>
                </div>
            </div>
                         <div class="single-hero-slide bg-img " style="background-image: url(images/banners/home-banner-3.jpg);">
                <div class="container-fluid h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 h-100">
                            <div class="hero-slides-content hero_1">
                                <h2 data-animation="fadeInUp" data-delay="100ms">We have been committed to diagnostics care for over a decade</h2>                               
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <div class="medilife-book-an-appoinment-area quickLink_section">
         ...
         <section class="medica-about-us-area section-padding-100">
        <div class="container">
            <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="lhd_heading wow fadeInLeft" data-wow-delay="0.2s" style="text-align: left; position: relative; color: #fff !important;">PATHOLOGY SERVICES</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
      ...
      <div class="col-4 col-sm-3 col-md-3 col-lg-2 pathology_icons wow fadeInUp" data-wow-delay="0.6s"><div class="pathology_inner " id="ids_n111"><div class="pathology_icon"><img src="images/icons/test-tube.png" ></div><div class="patho_name">Haematology</div></div></div>
 
      <div class="col-4 col-sm-3 col-md-3 col-lg-2 pathology_icons wow fadeInUp" data-wow-delay="0.8s"><div class="pathology_inner " id="ids_n110"><div class="pathology_icon"><img src="images/icons/flow.png" ></div><div class="patho_name">Flow Cytometry</div></div></div>
 
      <div class="col-4 col-sm-3 col-md-3 col-lg-2 pathology_icons wow fadeInUp" data-wow-delay="1s"><div class="pathology_inner " id="ids_n112"><div class="pathology_icon"><img src="images/icons/histopathology.png" ></div><div class="patho_name">Histopathology</div></div></div>
 
      <div class="col-4 col-sm-3 col-md-3 col-lg-2 pathology_icons wow fadeInUp" data-wow-delay="1.2s"><div class="pathology_inner " id="ids_n113"><div class="pathology_icon"><img src="images/icons/microbiology-icon.png" ></div><div class="patho_name">Microbiology</div></div></div>
      ...
      <div class="col-4 col-sm-3 col-md-3 col-lg-2 pathology_icons wow fadeInUp" data-wow-delay="1.6s"><div class="pathology_inner " id="ids_n115"><div class="pathology_icon"><img src="images/icons/cytogenetics.png" ></div><div class="patho_name">Cytogenetics</div></div></div>
        ...
        <div class="row">
            <div class="col-12 wow fadeInUp" data-wow-delay="2s">
                <div class="service_block ids_n108 service_block_show ">
                ...
                <div class="service_block ids_n114 ">
                ...
                <div class="service_block ids_n115 ">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="medica-about-content">
                        <h2 style="text-align:center;" class="wow fadeInUp" data-wow-delay="0s">MOBILE TEST SERVICES</h2>
                    </div>
                </div>
            </div>
        </div>
            <div class="mobile_test_wrapper">
                <div class="container">
                <div class="row">
                <div class="col-md-6">
...
border-bottom: 2px solid #137dc6;
    ...
    <script type="text/javascript" src="templates/assets/js/skrollr.min.js"></script>
