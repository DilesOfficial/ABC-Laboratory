...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO doctor (name, department, available_days, available_time, room_no,status,charge) 
    VALUES('$name','$department', '$available_days', '$available_time','$room_no','$status','$charge')";
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="dep">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Available Days <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="avd">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Available Time <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="avt">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Room no</label>
                                        <input class="form-control" type="text" id="rn">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="row justify-content-center">
                                    <div class="m-t-20 text-center">
                                        <button class="btn btn-primary submit-btn" type="submit" onclick="createD();">Create Doctor</button>
                                    </div>
                                </div>
                        </form>
                    </div>
