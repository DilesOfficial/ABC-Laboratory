...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO appointment (name, age, d_name, department, appointment_date,appointment_time,charge,fee) 
    VALUES('$name','$age', '$d_name', '$department','$appointment_date','$appointment_time','$charge' ,'$fee')";
