                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a class="active" href="employees.html">Technician List</a></li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-technician.php" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Technician</a>
                    </div>
                </div>
                <div class="row filter-row">
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus">
                            <label class="focus-label">Technician ID</label>
                            <input type="text" class="form-control floating">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus">
                            <label class="focus-label">Technician Name</label>
                            <input type="text" class="form-control floating">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                            ...
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>7 May 2015</td>
                                        <td>
                                            <span class="custom-badge status-green">Technician</span>
                                        </td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td>1 Jan 2013</td>
                                        <td>
                                            <span class="custom-badge status-blue">Technician</span>
                                        </td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
									...
									<tr>
                                        ...
                                        <td>27 Dec 2017</td>
                                        <td>
                                            <span class="custom-badge status-grey">Technician</span>
                                        </td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
